...
public class ItineraryService {
    ...
    public Map<Double, Double> getLongLat(String address) throws IOException {
        ...
        URL url = new URL(String.format("https://api-adresse.data.gouv.fr/search/?q=%s", address));
    ...
    public JSONArray curlItinerary(Map<Double, Double> departure, Map<Double, Double> arrival) throws IOException, InterruptedException {
